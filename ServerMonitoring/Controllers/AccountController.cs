...
namespace ServerMonitoring.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl = "/Home/Index")
        {
           ...
           // {
           //     client.BaseAddress = new Uri("http://localhost:61242");
           ...
           //     {
           //         signInResult = JsonConvert.DeserializeObject<SignInResult>(json);
           //     }
           ...
           // }
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    log.Info("model.Email: " + model.Email);
                    FormsAuthentication.SetAuthCookie(model.Email, true);
                  //  FormsAuthentication.SetAuthCookie(signInResult.AccessToken, true);
